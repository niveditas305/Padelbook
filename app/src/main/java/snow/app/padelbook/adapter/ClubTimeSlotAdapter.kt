...
import snow.app.padelbook.network.responses.favourite.CourtTime

class ClubTimeSlotAdapter(var context: Context,val courtTime: List<CourtTime>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
